# Integração com MISP – log-monitoramento

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **LOG MONITORAMENTO** com a plataforma [MISP](https://www.misp-project.org/).
