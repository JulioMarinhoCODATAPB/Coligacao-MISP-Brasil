# Integração com MISP – ids-ips

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **IDS IPS** com a plataforma [MISP](https://www.misp-project.org/).
