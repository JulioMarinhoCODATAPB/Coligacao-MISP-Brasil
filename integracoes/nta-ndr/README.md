# Integração com MISP – nta-ndr

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **NTA NDR** com a plataforma [MISP](https://www.misp-project.org/).
