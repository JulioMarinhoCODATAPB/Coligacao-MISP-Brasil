# Integração com MISP – edr-xdr

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **EDR XDR** com a plataforma [MISP](https://www.misp-project.org/).
