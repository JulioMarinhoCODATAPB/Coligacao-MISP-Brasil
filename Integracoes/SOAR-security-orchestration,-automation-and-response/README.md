# Integração com MISP – SOAR (Security Orchestration, Automation and Response)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **SOAR (Security Orchestration, Automation and Response)** com a plataforma [MISP](https://www.misp-project.org/).
