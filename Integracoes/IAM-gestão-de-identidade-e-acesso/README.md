# Integração com MISP – IAM / Gestão de Identidade e Acesso

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **IAM / Gestão de Identidade e Acesso** com a plataforma [MISP](https://www.misp-project.org/).
