# Integração com MISP – Firewall / Next-Gen Firewall

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **Firewall / Next-Gen Firewall** com a plataforma [MISP](https://www.misp-project.org/).
