# Integração com MISP – Ferramenta de Log / Monitoramento de Logs

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **Ferramenta de Log / Monitoramento de Logs** com a plataforma [MISP](https://www.misp-project.org/).
...
**Ferramenta de Log / Monitoramento de Logs**
