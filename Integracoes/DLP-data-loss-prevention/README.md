# Integração com MISP – DLP (Data Loss Prevention)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **DLP (Data Loss Prevention)** com a plataforma [MISP](https://www.misp-project.org/).
