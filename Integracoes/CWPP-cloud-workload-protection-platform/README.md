# Integração com MISP – CWPP (Cloud Workload Protection Platform)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **CWPP (Cloud Workload Protection Platform)** com a plataforma [MISP](https://www.misp-project.org/).
