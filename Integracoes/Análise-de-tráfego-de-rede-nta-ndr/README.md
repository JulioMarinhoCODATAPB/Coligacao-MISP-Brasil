# Integração com MISP – Análise de tráfego de rede (NTA/NDR)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **Análise de tráfego de rede (NTA/NDR)** com a plataforma [MISP](https://www.misp-project.org/).
...
**Análise de tráfego de rede (NTA/NDR)**
