# Integração com MISP – Honeypot

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **Honeypot** com a plataforma [MISP](https://www.misp-project.org/).
