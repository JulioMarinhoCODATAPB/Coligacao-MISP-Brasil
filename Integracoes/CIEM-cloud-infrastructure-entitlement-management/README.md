# Integração com MISP – CIEM (Cloud Infrastructure Entitlement Management)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **CIEM (Cloud Infrastructure Entitlement Management)** com a plataforma [MISP](https://www.misp-project.org/).
