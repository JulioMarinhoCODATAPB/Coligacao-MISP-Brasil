# Integração com MISP – SIEM (Security Information and Event Management)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **SIEM (Security Information and Event Management)** com a plataforma [MISP](https://www.misp-project.org/).
