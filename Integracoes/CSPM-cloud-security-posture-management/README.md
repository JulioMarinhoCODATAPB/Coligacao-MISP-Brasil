# Integração com MISP – CSPM (Cloud Security Posture Management)

Este diretório tem como objetivo organizar o desenvolvimento colaborativo da integração de soluções da categoria **CSPM (Cloud Security Posture Management)** com a plataforma [MISP](https://www.misp-project.org/).
